...
# 11강. 실감 콘텐츠 기획 및 제작 I

## 기획이란 무엇인가

- 콘텐츠:어떠한소재를구체적으로가공하여미디어를비롯한매체를통해표현하는무형의결과물
- 기획의 4단계 → Why, What, How, If
- 5why분석기법 → 토요타의시장이었던오노다이이치가‘어떠한문제상황에부딪혔을때왜를다섯번반복하면,진짜원인을알수있고진짜대책을세울수있다’면서근본적인원인의실마리를찾기위해사용 하던질문법

## 컨텐츠 제작 기획은 어떻게 시작되는가

- 목표를구체화하기위해확인해야할조건 ‘스마트(SMART)’ • Specific :구체적인가? • Measurable:측정가능한것인가? • Achievable :성취할수있는것인가? • Result-oriented :결과지향적인것인가? • Time-bounded :달성가능한날짜인가?

# 12강. 실감 콘텐츠 기획 및 제작 II
